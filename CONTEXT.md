...
- **Dependencies** combine explicit declarations with discovery of direct local Eco Component imports and relative side-effect CSS imports. Explicit asset settings take precedence; scripts retain explicit server and browser loading policy.
