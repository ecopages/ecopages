...
<RuiAlert variant="info" layout="banner" class="unstyled">
	<RuiAlertTitle>Explicit Dependencies</RuiAlertTitle>
	<RuiAlertDescription>
		<p>
			Ecopages does **not** automatically detect script files by name pattern. You must always include them in the
			`dependencies.scripts` array if you want them to be processed and included in the build.
		</p>
	</RuiAlertDescription>
</RuiAlert>
