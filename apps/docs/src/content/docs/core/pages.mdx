...
4. **`dependencies`**: Page-level scripts, stylesheets, and components discovery cannot follow (`export *` barrels, packages). Local component and CSS imports are discovered automatically.
