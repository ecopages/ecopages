...
<Banner type="alert">
  <BannerTitle>Framework Compatibility</BannerTitle>
...
<Banner type="info">
  <BannerTitle>Consistent Head Ordering Required</BannerTitle>
...
<Banner type="info">
  <BannerTitle>CSS exported via ecopages npm package</BannerTitle>
