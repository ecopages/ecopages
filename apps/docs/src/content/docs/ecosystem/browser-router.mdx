...
<RuiAlert variant="info" layout="banner" class="unstyled">
	<RuiAlertTitle>CSS exported via ecopages npm package</RuiAlertTitle>
	<RuiAlertDescription>
		<p>
			Due to a <a href="https://github.com/jsr-io/jsr/issues/293">JSR limitation</a>, CSS files cannot be exported
			from JSR packages. View transition styles are shipped via the <code>ecopages</code> npm package instead.
		</p>
	</RuiAlertDescription>
</RuiAlert>
