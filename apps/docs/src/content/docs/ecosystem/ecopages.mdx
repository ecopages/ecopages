	...
	tabs={[
		{
			id: 'npm',
			label: 'npm',
			code: 'npx ecopages init with-react-better-auth --template with-react-better-auth && cd with-react-better-auth && npm install && npm run db:generate && npm run db:migrate && npm run dev',
		},
		{
			id: 'pnpm',
			label: 'pnpm',
			code: 'pnpm dlx ecopages init with-react-better-auth --template with-react-better-auth && cd with-react-better-auth && pnpm install && pnpm run db:generate && pnpm run db:migrate && pnpm run dev',
		},
		{
			id: 'bun',
			label: 'bun',
			code: 'bunx ecopages init with-react-better-auth --template with-react-better-auth && cd with-react-better-auth && bun install && bun db:generate && bun db:migrate && bun dev',
		},
	]}
	defaultSelectedKey="npm"
/>
	...
	tabs={[
		{
			id: 'npm',
			label: 'npm',
			code: `npx ecopages init with-react-better-auth --template with-react-better-auth
...
npm run dev`,
		},
		{
			id: 'pnpm',
			label: 'pnpm',
			code: `pnpm dlx ecopages init with-react-better-auth --template with-react-better-auth
cd with-react-better-auth
pnpm install
...
pnpm run dev`,
		},
		{
			id: 'bun',
			label: 'bun',
			code: `bunx ecopages init with-react-better-auth --template with-react-better-auth
cd with-react-better-auth
bun install
bun db:generate
bun db:migrate
