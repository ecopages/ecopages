...
<CodeTabs
	...
	tabs={[
		...
		{ id: 'pnpm', label: 'pnpm', code: 'pnpx ecopages --help' },
...
<CodeTabs
	...
	tabs={[
		...
		{ id: 'pnpm', label: 'pnpm', code: 'pnpx ecopages init my-app' },
...
<CodeTabs
	...
	tabs={[
		...
		},
		{
			id: 'pnpm',
			label: 'pnpm',
			code: 'pnpx ecopages init ecopages-app && cd ecopages-app && pnpm install && pnpm dev',
		},
		{
			id: 'bun',
			label: 'bun',
...
<CodeTabs
	...
	tabs={[
		...
		},
		{
			id: 'pnpm',
			label: 'pnpm',
			code: 'pnpx ecopages init radiant-app --template radiant && cd radiant-app && pnpm install && pnpm dev',
		},
		{
			id: 'bun',
			label: 'bun',
...
<CodeTabs
	...
	tabs={[
		...
		},
		{
			id: 'pnpm',
			label: 'pnpm',
			code: 'pnpx ecopages init blog-jsx --template blog-jsx && cd blog-jsx && pnpm install && pnpm dev',
		},
		{
			id: 'bun',
			label: 'bun',
...
<CodeTabs
	...
	tabs={[
		...
		},
		{
			id: 'pnpm',
			label: 'pnpm',
			code: 'pnpx ecopages init blog-react --template blog-react && cd blog-react && pnpm install && pnpm dev',
		},
		{
			id: 'bun',
			label: 'bun',
...
<CodeTabs
	...
	tabs={[
		...
		},
		{
			id: 'pnpm',
			label: 'pnpm',
			code: 'pnpx ecopages init react-better-auth --template react-better-auth && cd react-better-auth && pnpm install && pnpm db:generate && pnpm db:migrate && pnpm dev',
		},
		{
			id: 'bun',
			label: 'bun',
...
npm run dev`,
		},
		{
			id: 'pnpm',
			label: 'pnpm',
			code: `pnpx ecopages init blog-jsx --template blog-jsx
cd blog-jsx
pnpm install
pnpm dev`,
		},
...
npm run dev`,
		},
		{
			id: 'pnpm',
			label: 'pnpm',
			code: `pnpx ecopages init blog-react --template blog-react
cd blog-react
pnpm install
pnpm dev`,
		},
...
npm run dev`,
		},
		{
			id: 'pnpm',
			label: 'pnpm',
			code: `pnpx ecopages init react-better-auth --template react-better-auth
cd react-better-auth
pnpm install
pnpm db:generate
pnpm db:migrate
