...
5. **AI-Ready Documentation**:
   - Includes [`llms.txt`](/llms.txt) and a progressive [`/skill/SKILL.md`](/skill/SKILL.md) agent skill pack.
...
Refer your AI agent to [`llms.txt`](/llms.txt) for the full docs index or [`/skill/SKILL.md`](/skill/SKILL.md) for the progressive agent skill pack.
