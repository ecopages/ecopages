...
- **[Ecopages JSX](/docs/integrations/ecopages-jsx)** – Preferred stack: Ecopages-owned `.tsx` routes with optional Radiant support
...
- **[KitaJS](/docs/integrations/kitajs)** – Optional: existing `.kita.tsx` / `@kitajs/html` apps
