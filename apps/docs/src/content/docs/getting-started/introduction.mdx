...
<Banner type="info">
	<BannerTitle>Agent skill pack</BannerTitle>
	<p>
		Start with <a href="/skill.txt">skill.txt</a> or <a href="/skill/SKILL.md">SKILL.md</a> for a progressive
		agent guide. Use <a href="/llms.txt">llms.txt</a> when you need the full generated docs export.
	</p>
</Banner>
