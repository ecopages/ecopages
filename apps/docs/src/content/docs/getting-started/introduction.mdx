...
<Banner type="alert">
	<BannerTitle>Beta Notice</BannerTitle>
	<p>
...
5. **AI-Ready Documentation**:
   - Progressive agent skill pack: [`skill.txt`](/skill.txt) and [`SKILL.md`](/skill/SKILL.md)
   - Full docs index: [`llms.txt`](/llms.txt)
...
<Banner type="info">
	<BannerTitle>Agent documentation</BannerTitle>
	<p>
		Ecopages exposes separate discovery indexes and markdown page exports for agents.
	</p>
	<table>
		<thead>
			<tr>
		...
		<tbody>
			<tr>
				<td>
					<a href="/skill.txt">skill.txt</a> / <a href="/skill/SKILL.md">SKILL.md</a>
				</td>
				<td>index + md modules</td>
				<td>Building or configuring Ecopages apps</td>
			</tr>
			<tr>
				<td>
				...
				<td>txt index</td>
				<td>Finding any docs page</td>
			</tr>
			<tr>
				<td>
					<code>/docs-llm/.../*.md</code>
				</td>
				<td>md pages</td>
				<td>Reading a specific generated doc export</td>
			</tr>
		</tbody>
	</table>
</Banner>
...
<CodeTabs
	...
	tabs={[
		{ id: 'pnpm', label: 'pnpm', code: `pnpm dlx ecopages init my-ecopages
cd my-ecopages
pnpm install
pnpm run dev` },
		{ id: 'npm', label: 'npm', code: `npx ecopages init my-ecopages
cd my-ecopages
npm install
npm run dev` },
		{ id: 'bun', label: 'bun', code: `bunx ecopages init my-ecopages
cd my-ecopages
bun install
bun run dev` },
	]}
