...
<RuiAlert variant="info" layout="banner" class="unstyled">
	<RuiAlertTitle>KitaJS vs Ecopages JSX</RuiAlertTitle>
	<RuiAlertDescription>
		<p>
			Use <a href="/docs/integrations/kitajs">KitaJS</a> when an HTML-first renderer should own{' '}
			<code>.kita.tsx</code> shells. Use Ecopages JSX when Ecopages should own standard <code>.tsx</code> routes,
			JSX runtime bundling, and optional Radiant hydration.
		</p>
	</RuiAlertDescription>
</RuiAlert>
