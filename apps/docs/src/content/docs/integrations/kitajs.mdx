...
<RuiAlert variant="info" layout="banner" class="unstyled">
	<RuiAlertTitle>Looking for Ecopages JSX?</RuiAlertTitle>
	<RuiAlertDescription>
		<p>
			Use <a href="/docs/integrations/ecopages-jsx">Ecopages JSX Integration</a> when Ecopages should own standard{' '}
			<code>.tsx</code> routes, runtime bundling, and optional Radiant hydration. KitaJS remains the HTML-first
			option for <code>.kita.tsx</code> shells.
		</p>
	</RuiAlertDescription>
</RuiAlert>
