---
title: "Server API"
description: "Create server endpoints and handle request/response logic with the Ecopages server API."
order: 1
---

# Server API

The server API defines HTTP endpoints, middleware, rendered responses, and WebSocket handlers.
