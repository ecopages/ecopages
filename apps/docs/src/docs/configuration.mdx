...
<ApiField name="scriptsExtension" type="string" defaultValue="script.ts">
Specifies the extension of the script files. This is used to identify the script files in the components directory.
...
The default value is `script.ts`, and it is strongly reccomended that if you change this value you keep a unique descriptor to avoid conflicts with other files.
</ApiField>
