...
| :--- | :--- | :--- | :--- |
| `enabled` | `boolean` | `true` (prod)<br/>`false` (dev) | Set to `false` to completely disable the cache service. Useful for debugging or when using an external CDN exclusively. |
