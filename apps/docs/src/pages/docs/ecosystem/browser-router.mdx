...
The `@ecopages/browser-router` package enables Single Page Application (SPA) navigation behavior in your Ecopages application. It intercepts link clicks, fetches the next page via fetch, and swaps the DOM content seamlessly, updating the browser history and merging `<head>` elements.
...
<div class="banner banner--alert" role="alert">
  <p class="banner__title">Framework Compatibility</p>
