...
<CodeSnippetTabs>
  <CodeTab name="pnpm">
```bash
pnpm dlx ecopages init ecopages-app && cd ecopages-app && pnpm install && pnpm run dev
```
  </CodeTab>
  <CodeTab name="npm">
```bash
...
<CodeSnippetTabs>
  <CodeTab name="pnpm">
```bash
pnpm dlx ecopages init blog-jsx --template blog-jsx && cd blog-jsx && pnpm install && pnpm run dev
```
  </CodeTab>
  <CodeTab name="npm">
```bash
...
<CodeSnippetTabs>
  <CodeTab name="pnpm">
```bash
pnpm dlx ecopages init blog-react --template blog-react && cd blog-react && pnpm install && pnpm run dev
```
  </CodeTab>
  <CodeTab name="npm">
```bash
...
<CodeSnippetTabs>
  <CodeTab name="pnpm">
```bash
pnpm dlx ecopages init with-react-better-auth --template with-react-better-auth && cd with-react-better-auth && pnpm install && pnpm run db:generate && pnpm run db:migrate && pnpm run dev
```
  </CodeTab>
  <CodeTab name="npm">
```bash
npx ecopages init with-react-better-auth --template with-react-better-auth && cd with-react-better-auth && npm install && npm run db:generate && npm run db:migrate && npm run dev
```
  </CodeTab>
  <CodeTab name="bun">
```bash
