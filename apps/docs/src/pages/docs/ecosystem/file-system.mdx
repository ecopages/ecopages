...
<CodeTabs
	tabs={[
		{ id: 'pnpm', label: 'pnpm', code: 'pnpm dlx jsr add @ecopages/file-system' },
		{ id: 'npm', label: 'npm', code: 'npx jsr add @ecopages/file-system' },
		{ id: 'bun', label: 'bun', code: 'bunx jsr add @ecopages/file-system' },
	]}
