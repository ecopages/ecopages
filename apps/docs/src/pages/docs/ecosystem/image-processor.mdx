...
<CodeSnippetTabs>
  <CodeTab name="pnpm">
```bash
pnpm dlx jsr add @ecopages/image-processor
```
  </CodeTab>
  <CodeTab name="npm">
```bash
npx jsr add @ecopages/image-processor
```
  </CodeTab>
  <CodeTab name="bun">
```bash
...
function MyComponent() {
	return (
		<Image src="/images/hero.jpg" alt="Hero image" width={800} height={600} loading="lazy" />
	);
}
```
