...
<CodeTabs
	tabs={[
		{ id: 'pnpm', label: 'pnpm', code: 'pnpm dlx jsr add @ecopages/image-processor' },
		{ id: 'npm', label: 'npm', code: 'npx jsr add @ecopages/image-processor' },
		{ id: 'bun', label: 'bun', code: 'bunx jsr add @ecopages/image-processor' },
	]}
