...
<ApiField
	name="includesTemplates"
	type="IncludesTemplates"
	defaultValue="{head: 'head.ghtml.ts', html: 'html.ghtml.ts', seo: 'seo.ghtml.ts'}"
	setter="setIncludesTemplates"
>
...
<ApiField
	name="robotsTxt"
	type="RobotsPreferences"
	defaultValue={`{ preferences: { "*": [], Googlebot: ["/public/"] } }`}
	setter="setRobotsTxt"
>
...
<ApiField name="loaders" type="BunPlugin[]" defaultValue="[]" setter="setLoaders">
	An array of Bun plugins to use as loaders for custom file types.
</ApiField>
