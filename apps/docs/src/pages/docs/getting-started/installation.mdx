...
<CodeTabs
	tabs={[
		{ id: 'pnpm', label: 'pnpm', code: 'pnpm dlx jsr add @ecopages/core @ecopages/kitajs @ecopages/mdx' },
		{ id: 'npm', label: 'npm', code: 'npx jsr add @ecopages/core @ecopages/kitajs @ecopages/mdx' },
		{ id: 'bun', label: 'bun', code: 'bunx jsr add @ecopages/core @ecopages/kitajs @ecopages/mdx' },
	]}
