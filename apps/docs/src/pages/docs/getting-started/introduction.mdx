...
<div class="banner banner--alert" role="alert">
  ...
  <p>The Ecopages documentation is currently in beta. The API is not stable yet and will have major changes before the first stable release. Use at your own risk.</p>
</div>
