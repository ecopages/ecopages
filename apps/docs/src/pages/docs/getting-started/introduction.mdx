...
<CodeSnippetTabs>
  <CodeTab name="pnpm">
```bash
pnpm dlx degit ecopages/ecopages/examples/starter-jsx my-ecopages
```
  </CodeTab>
  <CodeTab name="npm">
```bash
npx degit ecopages/ecopages/examples/starter-jsx my-ecopages
```
  </CodeTab>
  <CodeTab name="bun">
```bash
...
cd my-ecopages
bun install
bun run dev # or npm/pnpm equivalent
```
  </CodeTab>
</CodeSnippetTabs>
