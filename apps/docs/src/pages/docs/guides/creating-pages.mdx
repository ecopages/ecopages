...
export const getMetadata = () => ({
  ...
  description: 'Learn how to create pages in Eco Pages using the ghtml integration',
})

# Creating Pages in Eco Pages

Pages are the core of your Eco Pages project. They represent the different routes and content of your website. In this guide, we'll explore how to create pages using the ghtml integration.

## Basic Page Structure

A typical page in Eco Pages using the ghtml integration consists of a single TypeScript file. Here's a basic example:
...
const HomePage: EcoComponent = () => html\`\${BaseLayout({
    ...
    children: html\`
      ...
      <p>Welcome to my Eco Pages website!</p>
    \`,
  })}\`;
...
Eco Pages provides powerful tools for lazy loading components, which can significantly improve your site's performance. Two key functions for this are `resolveComponentsScripts` and `removeComponentScripts`.
