...
This setup allows both KitaJS and MDX in the same project, giving flexibility in how pages and components are authored. Set `jsxImportSource` to `@kitajs/html` in the MDX plugin options to keep the JSX runtime compatible.
