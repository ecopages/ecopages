...
<CodeTabs
	tabs={[
		{ id: 'pnpm', label: 'pnpm', code: 'pnpm dlx jsr add @ecopages/react' },
		{ id: 'npm', label: 'npm', code: 'npx jsr add @ecopages/react' },
		{ id: 'bun', label: 'bun', code: 'bunx jsr add @ecopages/react' },
	]}
