...
const configExampleCode = `import path from 'node:path';
...
const pageExampleCode = `import { eco } from '@ecopages/core';
import { BaseLayout } from '@/layouts/base-layout';
  ...
  render: () => (
    <section>
      <h1>Build fast static pages with TypeScript</h1>
			<p>Start with the Ecopages JSX Integration for first-party defaults, 
			then add other Integrations as needed.</p>
      <a href='/docs/getting-started/introduction'>Read the docs</a>
    </section>
  ),
});`;

const configExample = await codeToHtml(configExampleCode, {
	lang: 'tsx',
	themes: { light: 'light-plus', dark: 'dark-plus' },
	defaultColor: false,
});

const pageExample = await codeToHtml(pageExampleCode, {
	lang: 'tsx',
	themes: { light: 'light-plus', dark: 'dark-plus' },
	defaultColor: false,
});
