...
- Direct local Eco Component imports and relative side-effect CSS imports supply Dependencies by default. Explicit stylesheet declarations override inferred references to the same resolved file. Inferred styles stay on Component identity until collection.
