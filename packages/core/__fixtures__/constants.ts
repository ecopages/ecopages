...
export const FIXTURE_CSS_FILE_ERROR = path.resolve(__dirname, 'css/error.css');
...
export const FIXTURE_EXISTING_SVG_FILE_IN_DIST_PATH = `${FIXTURE_APP_PROJECT_DIR}/dist/${FIXTURE_EXISTING_SVG_FILE_IN_DIST}`;
