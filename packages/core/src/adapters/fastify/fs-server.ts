...
import { FastifyServer } from './hmr-server';

export class FastifyFileSystemServerAdapter implements EcoPagesFileSystemServerAdapter {
  ...
  static async create({
    ...
    const server = new FastifyFileSystemServerAdapter({
      router,
      appConfig: appConfig,
