...
- Fixed router-backed React documents to emit an explicit document owner marker so cross-router handoff no longer depends on hydration-script heuristics.
