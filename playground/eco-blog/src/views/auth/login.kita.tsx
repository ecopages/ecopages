...
export const LoginView = eco.page<PropsWithChildren<{}>>({
	...
	dependencies: {
		scripts: ['/src/views/auth/login.script.ts'],
	},
	render: () => {
		return (
			<body class="bg-slate-50 min-h-screen flex items-center justify-center p-4 antialiased font-sans">
				<div class="max-w-md w-full bg-white p-8 rounded-3xl shadow-xl border border-slate-200">
					<div class="text-center mb-8">
						...
						<p class="text-slate-500 mt-2">Sign in to your author account</p>
					</div>

					<form action="/api/auth/sign-in/email" method="POST" class="space-y-6">
						<div class="space-y-2">
					...
					<p class="text-center text-slate-500 text-sm mt-8">
						...
						<a href="/signup" class="text-indigo-600 font-bold hover:text-indigo-500">
							Sign up
						</a>
					</p>
				</div>
