...
export default eco.page({
	...
	metadata: () => ({
		title: 'API lab',
		description: 'Manual entry points for the Nitro host API handlers that run beside the Ecopages app.',
	}),
	render: () => {
		return (
			<div class="api-lab">
				<section class="api-lab__intro">
					<p class="api-lab__eyebrow">Host APIs</p>
					<h1 class="api-lab__title">Host API routes served beside the Ecopages app</h1>
					<p class="api-lab__summary">
						The Nitro host keeps JSON handlers beside the Ecopages pages so the playground can exercise
						host-native APIs and Ecopages render routes in one app shell.
					</p>
