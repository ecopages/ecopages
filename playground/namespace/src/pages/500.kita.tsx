			...
			<BaseLayout>
				<div class="max-w-2xl mx-auto text-center flex flex-col items-center justify-center min-h-[50vh] space-y-8">
					<div class="space-y-4">
						...
						<h2 class="text-2xl md:text-3xl font-bold text-white">Something went wrong</h2>
						<p class="text-gray-400 text-lg">
							{message ?? 'An unexpected error occurred while rendering this page.'}
						</p>
					</div>
					{stack ? (
						<pre class="w-full max-h-80 overflow-x-auto whitespace-pre-wrap rounded-lg border border-white/10 bg-black/40 p-4 text-left text-xs text-gray-300">
							{stack}
						</pre>
					) : null}
					<div class="pt-8">
