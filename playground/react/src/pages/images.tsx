	...
	return (
		<BaseLayout className="grid gap-12 px-4 py-8">
			...
			<section className="space-y-6">
				...
				<p className="text-sm">
					The following image is generated on the client side using the ClientImageGenerator component, it
					stores the image metadata of the imported images from the virtual module. Thanks to the
					three-shaking capabilities of Ecopages, only the necessary images are included in the final bundle.
				</p>
