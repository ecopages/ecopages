...
import { applyWorkspaceOverrides, rewritePackageJsonForLocalDist } from './debug-app-link-local.mjs';
...
async function withLinkedLocalPackages(config, matchedPackages, runBody) {
	...
	try {
		...
		rewritePackageJsonForLocalDist(packageJson, matchedPackages);
		writeJson(packageJsonPath, packageJson);

		if (workspaceBackup && workspaceYamlPath) {
			applyWorkspaceOverrides(workspaceYamlPath, workspaceBackup, matchedPackages);
		}
