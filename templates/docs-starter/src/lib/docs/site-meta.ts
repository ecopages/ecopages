/**
 * SEO and site-origin helpers for the docs starter.
 *
 * @remarks
 * Mirrored from `apps/docs/src/lib/docs/site-meta.ts` on purpose:
...
export const SITE_NAME = 'Docs starter';
export const DEFAULT_SITE_ORIGIN = 'http://localhost:3000';
export const DOCS_SITEMAP_EXTRA_URLS = ['/llms.txt'] as const;
