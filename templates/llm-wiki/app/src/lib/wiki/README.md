...
Catalog ordering preserves every page by slug, including pages with the same title. Graph lint parses Markdown links and reference definitions; code examples, images, and unused definitions do not count as inbound links.
