 ...
 *
 * The host draws the track, the thumbs and the optional value readout.
 * `value` is `number[]` (`[50]`, or `[25, 75]` for a range). `showValue` sits
 * the readout on the same row as the track. Its own `label` is the thumbs'
...
export type SliderProps = JsxCustomElementAttributes<RuiSliderElement, RuiSliderProps>;
